...
class CourseSectionResourceController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        // return redirect()->route('instructors.course.sections.show', $section->id)->with('success_msg', 'Resource created successfully!');
        return redirect()->back()->with('success_msg', 'Course section resource created successfully!');
    }
