...
class CourseController extends Controller
{
    ...
    {
        $courses = $this->Course->model()->where('user_id' , auth('web')->id())->paginate(50);
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('instructors.course.details.show' , $course->id)->with('success_msg', 'Courses created successfully!');
    }
