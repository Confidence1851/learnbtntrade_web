...
class CourseSectionController extends Controller
{
    ...
    public function index()
    {
        ...
        // return view('instructor.course_sections.index',compact('sections'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('instructors.course.details.show', $course->id)->with('success_msg', 'Course section created successfully!');
    }
    ...
    {
        $section = $this->CourseSection->find($id);
        return view('instructor.course_sections.show', compact('section'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('instructor.course_sections.edit', compact('section' , 'courses'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('instructors.course.sections.show' , $section->id)->with('success_msg', 'Course section updated successfully!');
    }
