@extends('instructor.layout.app',[ 'pageTitle' =>  'New Course Section' , 'activeGroup'  => 'course', 'activePage' => 'course_all'])
@section('content')
                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    <a href="{{ route('instructors.course.details.show', $course->id) }}" class="btn btn-sm btn-outline-primary"> Back to list</a>
                                </li>
                            </ul>
                        </div>
                        <div class="body">
                            <form action="{{ route('instructors.course.sections.store')}}" method="post" enctype="multipart/form-data">@csrf
                                <div class="row">
