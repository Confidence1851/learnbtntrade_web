                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    <a href="{{ route('instructor.course.details.create') }}" class="btn btn-sm btn-outline-primary"> New Course</a>
                                </li>
                            </ul>
                        </div>
                        <div class="body">
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">  <!-- js-basic-example -->
                                    ...
                                    <tbody>
                                        ...
                                        <td><img src="{{ getFileFromStorage($course->image) }}" alt="" class="img-responsive" width="100"></td>
                                            ...
                                            <td>
                                                <form  action="{{ route('instructor.course.details.destroy',$course) }}" method="POST">
                                                    @method('delete')
                                                    @csrf
                                                    <a href="{{ route('instructor.course.details.show',$course) }}" class="btn btn-info sm">
                                                        <i class="material-icons">remove_red_eye</i>
                                                    </a>
                                                    <a href="{{ route('instructor.course.details.edit',$course) }}" class="btn btn-success sm">
