@extends('instructor.layout.app',[ 'pageTitle' =>  'Course Section Information' , 'activeGroup'  => 'course', 'activePage' => 'course_all'])
@section('content')
     <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5 mt-4 md-mt-0">
                                <li class="dropdown">
                                    <a href="{{ route('instructors.course.sections.edit' , $section->id) }}" class="btn btn-sm btn-outline-primary"> Edit Section</a>
                                </li>
                            </ul>
                        </div>
                        <div class="body">
                                        ...
                                        <div class="panel panel-default panel-post">
                                            ...
                                            <div class="panel-body">
                                                <div class="row" style="padding:10px ">
                                                    ...
                                                    <div class="col-md-6"><br>
                                                        <div class="p-3">
                                                            <video src="{{ route('instructors.course.sections.file', encrypt($section->id)) }}" controls class="img-responsive" style="max-height: 400px"></video>
                                                        </div>
                                                    </div>
                                                                    ...
                                                                    <table class="table table-bordered table-striped table-hover dataTable js-exportable">  <!-- js-basic-example -->
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <form  action="{{ route('instructors.course.resources.destroy',$resource) }}" method="POST">
                                                                                        @method('delete')
                                                                                        @csrf
                                                                                        <a href="{{ route('instructors.course.resources.show' , $resource)}}" class="btn btn-info sm" onclick=" return confirm('Are you sure you want to download this item? it may cost you money!');">
                                                                                ...
                                                                                <div class="modal fade" id="edit_resource_{{ $resource->id }}" tabindex="-1" role="dialog">
                                                                                    <div class="modal-dialog modal-md" role="document">
                                                                                        ...
                                                                                        <form action="{{ route('instructors.course.resources.update', $resource->id ) }}" method="post" enctype="multipart/form-data">
                                                                                            @method('put')
                                                                                            @csrf
        ...
        <div class="modal fade" id="new_resource" tabindex="-1" role="dialog">
            <div class="modal-dialog modal-md" role="document">
                ...
                <form action="{{ route('instructors.course.resources.store') }}" method="post" enctype="multipart/form-data">@csrf
                    <div class="modal-body">
                        <input type="hidden" name="course_section_id" value="{{ $section->id }}" required>
