@extends('instructor.layout.app',[ 'pageTitle' =>  'New Course' , 'activeGroup'  => 'course', 'activePage' => 'course_all'])
@section('content')
                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    <a href="{{ route('instructors.course.details.index') }}" class="btn btn-sm btn-outline-primary"> Back to list</a>
                                </li>
                            </ul>
                        </div>
                        <div class="body">
                            <form action="{{ route('instructors.course.details.store')}}" method="post" enctype="multipart/form-data">@csrf
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea id="sun_editor" type="text" name="description" class="form-control" required>{!! old('description') !!}</textarea>
                                            </div>
                                            @error('description')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
