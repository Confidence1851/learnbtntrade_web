@extends('instructor.layout.app',[ 'pageTitle' =>  'Courses' , 'activeGroup'  => 'course', 'activePage' => 'course_all'])
@section('content')
                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    <a href="{{ route('instructors.course.details.create') }}" class="btn btn-sm btn-outline-primary"> New Course</a>
                                </li>
                            </ul>
                        </div>
                        <div class="body">
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">  <!-- js-basic-example -->
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form  action="{{ route('instructors.course.details.destroy',$course) }}" method="POST">
                                                    @method('delete')
                                                    @csrf
                                                    <a href="{{ route('instructors.course.details.show',$course) }}" class="btn btn-info btn-xs">
                                                        <i class="material-icons">remove_red_eye</i>
                                                    </a>
                                                    <a href="{{ route('instructors.course.details.edit',$course) }}" class="btn btn-success btn-xs">
