@extends('instructor.layout.app',[ 'pageTitle' =>  'Course Information' , 'activeGroup'  => 'course', 'activePage' => 'course_all'])
@section('content')
                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5 mt-4 md-mt-0">
                                <li class="dropdown">
                                    <a href="{{ route('instructors.course.details.edit' , $course->id) }}" class="btn btn-sm btn-outline-primary"> Edit Course</a>
                                </li>
                            </ul>
                        </div>
                        <div class="body">
                                            ...
                                            <div class="panel-heading">
                                                <h3>Course Sections
                                                    <span style="float: right">
                                                         <a href="{{ route('instructors.course.sections.create', $course->id) }}" class="btn btn-sm btn-outline-primary"> New Section</a>
                                                    </span>
                                                </h3>
                                            </div>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <form  action="{{ route('course.comments.destroy',$section) }}" method="POST">
                                                                                        @method('delete')
                                                                                        @csrf
                                                                                        <a href="{{ route('instructors.course.sections.show' , $section->id) }}" class="btn btn-info xs">
                                                                                            <i class="material-icons">remove_red_eye</i>
                                                                                        </a>
                                                                                        <a href="{{ route('instructors.course.sections.edit' , $section->id) }}" class="btn btn-success xs">
