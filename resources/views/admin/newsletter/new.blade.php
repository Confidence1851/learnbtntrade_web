@extends('dashboard_layout.app',[ 'pageTitle' =>  'Course Section Information' , 'activeGroup'  => 'course', 'activePage' => 'course_all'])
@section('content')
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea id="sun_editor" type="text" name="message" class="form-control" placeholder="Use &#123;&#123;name&#125;&#125; to represent the person`s name" required>{!! old('message') !!}</textarea>
                                                                    </div>
                                                                    @error('message')
                                                                        <span class="invalid-feedback" role="alert">
                                                                            <strong>{{ $message }}</strong>
