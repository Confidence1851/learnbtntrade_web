@extends('dashboard_layout.app',[ 'pageTitle' =>  'Courses' , 'activeGroup'  => 'course', 'activePage' => 'course_all'])
@section('content')
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">  <!-- js-basic-example -->
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form  action="{{ route('course.test.questions.destroy',$course) }}" method="POST">
                                                    @method('delete')
                                                    @csrf
                                                    <a href="{{ route('course.test.questions.show',$course) }}" class="btn btn-info btn-xs">
                                                        <i class="material-icons">remove_red_eye</i>
                                                    </a>
                                                    <a href="{{ route('course.test.questions.edit',$course) }}" class="btn btn-success btn-xs">
