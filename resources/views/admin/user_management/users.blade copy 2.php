@extends('dashboard_layout.app',[ 'pageTitle' =>  'Users Management | Users' , 'activeGroup'  => 'users_management', 'activePage' => 'users'])
@section('content')
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">  <!-- js-basic-example -->
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>NGN 5,000</td>
                                            <td>Active</td>
                                            <td><button class="btn btn-outline-primary sm">More Info</button></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
