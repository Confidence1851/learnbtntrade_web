@extends('dashboard_layout.app',[ 'pageTitle' =>  'Users Management | Processing Users' , 'activeGroup'  => 'users_management', 'activePage' => 'users'])
@section('content')
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">  <!-- js-basic-example -->
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="text-center"><img src="{{asset('dashboard')}}/images/user.png" width="30" height="30"  alt="Avatar" /></td>
                                            <td>{{$user->name}}</td>
                                            <td>{{$user->email}}</td>
                                            <td>{{$user->phone}}</td>
