                ...
                <div class="card">
                    <div class="header">
                        ...
                        <ul class="header-dropdown m-r--5">
                            <li class="dropdown">
                                <a href="{{ route("testimonials.create") }}" class="btn btn-sm btn-outline-primary"> New Testimonial</a>
                            </li>
                        </ul>
                    </div>
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-basic-example">
                                ...
                                <tbody>
                                    @foreach ($testimonials as $testimonial)
                                        <tr>
                                            <td class="text-center"><img src="{{ $testimonial->getAvatar() }}" width="30"
                                                    height="30" alt="Avatar" /></td>
                                            <td>{{ $testimonial->name }}</td>
                                            <td>{{ $testimonial->title }}</td>
                                            <td>{{ ucfirst($testimonial->content_type) }}</td>
                                            <td>
                                    ...
                                    <td>
                                        <form action="{{ route('testimonials.destroy', $testimonial) }}" method="POST">
                                            @method('delete')
                                            @csrf
                                            <a href="{{ route("testimonials.edit" , $testimonial->id) }}" class="btn btn-info sm" >
                                    ...
                                    <div class="modal fade" id="edit_item_{{ $testimonial->id }}" tabindex="-1"
                                        role="dialog">
                                        <div class="modal-dialog modal-md" role="document">
                                            <div class="modal-content">
                                                ...
                                                <form action="{{ route('testimonials.update', $testimonial) }}"
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group" id="title">
                                                            <div class="form-line">
                                                                ...
                                                                <input type="text" name="title" class="form-control"
                                                                    required placeholder="e.g Student"
                                                        ...
                                                        <div class="form-group">
                                                            <div class="form-line">
                                                                ...
                                                                <select type="text" name="featured" required
                                                                    class="form-control" required>
                                                                    <option disabled selected></option>
                                                                    <option value="0"
                                                                        {{ $testimonial->featured == 0 ? 'selected' : '' }}>
                                                                        No</option>
                                                                    <option value="1"
                                                                        {{ $testimonial->featured == 1 ? 'selected' : '' }}>
                                                                        Yes</option>
                                                                </select>
                                                            </div>
                                                            @error('status')
