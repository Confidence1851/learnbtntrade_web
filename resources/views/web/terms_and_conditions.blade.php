@extends('web.layouts.app' , ['title' => 'Terms and Conditions'   , 'activePage' => '' , 'meta_keywords' => '' , 'meta_description' => '' ])
@section('content')
<div class="container mt-5">
   <div class="text-center"><h1> TERMS AND CONDITION</h1></div>
    <h5 class="mt-3">AGREEMENT TO TERMS</h5>
    <p>
        These Terms of Use constitute a legally binding agreement made between you, whether personally or
        on behalf of an entity (“you”) and LEARNBTCTRADE ACADEMY (“Company“, “we”, “us”, or “our”),
        concerning your access to and use of the LEARNBTCTRADEACADEMY.com website as well as any other
...
<h5 class="mt-3">INTELLECTUAL PROPERTY RIGHTS</h5>
<p>
...
laws and various other intellectual property rights and unfair competition laws of the Nigeria, foreign
...
<h5 class="mt-3">USER REPRESENTATIONS</h5>
<p>
...
<h5 class="mt-3">USER REGISTRATION</h5>
<p>
You are required to register with the Site. You agree to keep your password confidential and will be
...
<h5 class="mt-3">REFUND POLICY</h5>
<p>
Once you purchase a course, you have a lifetime access to all the features listed under the specific
...
Contributions you transmit may be treated in accordance with the Site Privacy Policy. When you create
...
applicable laws in the Nigeria, then through your continued use of the Site, you are transferring your
...
AAA Consumer Rules. If such costs are determined by the arbitrator to be excessive, we will pay all
...
applicable AAA rules or applicable law, the arbitration will take place in Nigeria County, California.
...
ACCESS TO AND USE OF THE SITE, (3) ANY UNAUTHORIZED ACCESS TO OR USE OF OUR SECURE SERVERS
...
VIRUSES, TROJAN HORSES, OR THE LIKE WHICH MAY BE TRANSMITTED TO OR THROUGH THE SITE BY
...
A THIRD PARTY THROUGH THE SITE, ANY HYPERLINKED WEBSITE, OR ANY WEBSITE OR MOBILE
...
TIMES BE LIMITED TO THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE ONE (1) MONTH PERIOD
PRIOR TO ANY CAUSE OF ACTION ARISING. CERTAIN STATE LAWS DO NOT ALLOW LIMITATIONS ON
