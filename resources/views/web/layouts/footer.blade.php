          ...
          <div class="col-md-4">
            <div class="widget">
              ...
              <ul class="list-inline m-a0">
                ...
                <li><a target="_blank" href="https://www.instagram.com/learnbtctrade_/?utm_medium=copy_link" class="site-button instagram circle "><i class="fa fa-instagram"></i></a></li>
                <li><a target="_blank" href="https://twitter.com/Learnbtctrade?s=09" class="site-button twitter circle "><i class="fa fa-twitter"></i></a></li>
              </ul>
            </div>
          </div>
        </div>
