@extends('dashboard_layout.app',[ 'pageTitle' =>  'Blog Posts' , 'activeGroup'  => 'blog', 'activePage' => 'post'])
@section('content')
                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    <a href="{{ route('blogger.posts.create') }}" class="btn btn-sm btn-outline-primary"> New Post</a>
                                </li>
                            </ul>
                        </div>
                        <div class="body">
